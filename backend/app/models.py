from sqlalchemy import String, ForeignKey, DateTime, LargeBinary, Boolean, Text
...
class Device(Base):
    ...
    # public key of device for E2EE key exchange (X25519), base64 string stored as text
...
class Message(Base):
    ...
    # E2EE payload: opaque ciphertext (JSON blob, base64 etc.) - server doesn't decrypt
...
class Attachment(Base):
    ...
    # stored encrypted bytes on disk
